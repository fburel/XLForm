Pod::Spec.new do |s|
  ...
  s.description = <<-DESC
                  ...
                  DESC
  s.homepage = 'https://github.com/jrivelli/XLForm'
  s.authors  = 'NTST' 
  s.source   = { :git => 'https://github.com/jrivelli/XLForm.git', :tag => s.version.to_s }
  s.source_files = 'XLForm/XL/**/*.{h,m}'
  s.requires_arc = true
  s.ios.deployment_target = '7.0'
  s.ios.frameworks = 'UIKit', 'Foundation', 'CoreGraphics'
  #s.resource = 'XLForm/XLForm.bundle'
  s.resource_bundles = {'XLResource' => ['XLForm/XL/**/*.{xib,png,jpeg,jpg}']}
end
